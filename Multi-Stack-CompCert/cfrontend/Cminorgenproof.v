...
Proof.
  ...
  auto.
  eapply Mem.push_stage_right_inject. auto. rewrite Mem.astack_push_stage. auto.
...
======= *)
  ...
  simpl in s. rewrite STK1 in s. destr_in s. destruct p; simpl in s. inv s. inv H4. reflexivity. inv H0.
  destruct n0; simpl in s; inv s. reflexivity.
  ...
  split. apply struct_eq_refl. simpl. auto.
  apply Mem.sup_include_refl.
