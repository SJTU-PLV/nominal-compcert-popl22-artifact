...
Proof.
  ...
  rewrite STK1 in s; eauto. destr_in s.
  destruct p. inv s. inv H5. auto. inv H. simpl in s. destruct n0; simpl in s; inv s. auto.
  econstructor; split.
  econstructor.
  ...
  apply Mem.sup_include_refl. apply Mem.sup_include_refl.
  apply Genv.genv_vars_eq in H1. subst. auto. split.
  apply struct_eq_refl. auto.
  constructor.
  generalize (match_program_main (proj1 TRANSF)). simpl; auto.
Qed.
